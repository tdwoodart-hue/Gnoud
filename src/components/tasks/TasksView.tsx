...
export const TasksView: React.FC = () => {
  ...
  return <div className="mx-auto max-w-2xl">
    ...
    {visible.length === 0 ? <EmptyState title="Không có công việc" /> : <div className="space-y-2">{visible.map((task) => <div key={task.id} className="flex min-h-[76px] items-center gap-3 rounded-2xl bg-white px-4 ring-1 ring-slate-200">
